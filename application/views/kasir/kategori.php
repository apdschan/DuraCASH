    ...
    <div class="modal-container" id="addModal">
        <div class="modal-content">
            ...
            <div id="addContent">
                ...
                <form action="<?php echo base_url("kasir/kasir/tambahkategori");?>" method="post">
...
<?php include('layout/footer.php') ?>
    ...
    function openEditModalKategori(id) {
        ...
        $.ajax({
            ...
            url: '<?= base_url() ?>kasir/kasir/editmodalkategori/' +id, // Replace with the actual ID
            data: {
                id: id,
            },
    ...
    function confirmDelete() { 
        ...
        $.ajax({
            ...
            url: "<?= base_url() ?>kasir/kasir/deletekategori/", // Replace with your server endpoint
