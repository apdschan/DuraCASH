    ...
    <div class="modal-container" id="addModal">
        <div class="modal-content">
            ...
            <div id="addContent">
                ...
                <!-- Example: -->
                <form action="<?php echo base_url("kasir/kasir/tambahpelanggan");?>" method="post">
...
<div class="modal-container" id="deleteModal">
    ...
    function openEditModal(id) {
        ...
        $.ajax({
            ...
            url: '<?= base_url() ?>kasir/kasir/editmodal/' +id, // Replace with the actual ID
            data: {
                id: id,
            },
    ...
    function confirmDelete() {  // Get the customer ID from the data attribute
        ...
        $.ajax({
            ...
            url: "<?= base_url() ?>kasir/kasir/deleteCustomer/", // Replace with your server endpoint
