...
<body>
    ...
    <div class="navbar">
        <div class="logo">
            ...
            <a href="<?php echo base_url("kasir/dashboard/" . $data_kasir->UserID)?>" >DuraCASH</a>
        </div>

        <div class="account-section">
            <a href="<?php echo base_url("kasir/akun/" . $data_kasir->UserID)?>" >
    ...
    <div id="sidebar" class="sidenav">
        <div class="sidebar-item" tabindex="0" id="dashboard">
            <a href="<?php echo base_url("kasir/dashboard/" . $data_kasir->UserID)?>">
        ...
        <div class="sidebar-item" id="customer">
            <a href="<?php echo base_url("kasir/customer/" . $data_kasir->UserID)?>">
                <i class="ion-ios-people-outline ion-2x"></i>
                Pelanggan
            </a>
        </div>
        
        <div class="sidebar-item" id="toko">
            <a href="<?php echo base_url("kasir/toko/" . $data_kasir->UserID)?>">
                <i class="ion-ios-cart-outline ion-2x"></i>
                Toko
            </a>
        </div>

        <div class="sidebar-item" id="laporan">
            <a href="<?php echo base_url("kasir/laporan/" . $data_kasir->UserID)?>">
                <i class="ion-ios-paper-outline ion-2x"></i>
                Laporan
            </a>
        </div>

        <div class="sidebar-item" id="transaksi">
            <a href="<?php echo base_url("kasir/transaksi/" . $data_kasir->UserID)?>">
                <i class="ion-monitor ion-2x"></i>
                Transaksi
            </a>
        </div>

        <div class="sidebar-item" id="riwayatTransaksi">
            <a href="<?php echo base_url("kasir/riwayatTransaksi/" . $data_kasir->UserID)?>">
