...
<body>
    ...
    <div class="info-container">
        <button class="edit-acc" onclick="openEditPopup(<?php echo $data_kasir->UserID; ?>)">
            <i class="ion-edit"></i> Edit
        </button>
        <p><strong>Name : </strong><?php echo $data_kasir->NamaUser; ?></p>
        <p><strong>Email : </strong><?php echo $data_kasir->Email; ?></p>
        <p><strong>Address : </strong><?php echo $data_kasir->AlamatJalan . ", " . $data_kasir->AlamatKelurahan . ", " . $data_kasir->AlamatKecamatan . ", " . $data_kasir->AlamatKabupatenKota . ", " . $data_kasir->AlamatProvinsi .", " . $data_kasir->AlamatKodePos; ?></p>
        <p><strong>Telephone : </strong><?php echo $data_kasir->NomorTelepon; ?></p>
    </div>
...
<script>
    ...
    function openEditPopup(id) {
            $.ajax({
                ...
                url: '<?= base_url() ?>kasir/kasir/editmodalakun/' +id, // Replace with the actual ID
                data: {
                    id: id,
                },
