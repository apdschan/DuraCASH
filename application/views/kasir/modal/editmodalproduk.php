<title>Customer</title>
    ...
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
        <div class="modal-content">
            ...
            <h3>Edit Produk</h3>
            <div id="editContent">
            <form id="formedit" method="post" action="<?php echo base_url('kasir/kasir/editproduk')?>">
            ...
            <?php $kategoribyid = $this->Kasir_Model->kategoribyidkategori($dataprodukbyid->KategoriID)?>
