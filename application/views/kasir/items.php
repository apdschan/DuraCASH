        ...
        <table class="table table-bordered" id="tabelProduk">
            ...
            <tbody>
                ...
                <?php foreach ($list_produk as $data) : ?>
                        <?php $kategoribyid = $this->Kasir_Model->kategoribyidkategori($data->KategoriID);?>
                    <tr data-kategori="<?php echo $data->KategoriID; ?>">
                        <td><?php echo $data->NamaProduk; ?></td>
                        <td><?php echo $kategoribyid->NamaKategori; ?></td>
                        <td><?php echo $data->Stok; ?></td>
                        <td><?php echo "Rp. " . $data->HargaBeli; ?></td>
                        <td>
                            <?php
...
// Function to open the Edit Modal
    function openEditModal(id) {
        ...
        $.ajax({
            ...
            url: '<?= base_url() ?>kasir/kasir/editmodalproduk/' +id, // Replace with the actual ID
            data: {
                id: id,
            },
    ...
    function confirmDelete() {  // Get the customer ID from the data attribute
        ...
        $.ajax({
            ...
            url: "<?= base_url() ?>kasir/kasir/deleteproduk/", // Replace with your server endpoint
