...
<?php 
$detail = $this->Kasir_Model->getDataByTransactionID($data_laporan->PenjualanID);
$pelanggan = $this->Kasir_Model->customerbyid($data_laporan->PelangganID);
?>
...
<div class="containerstruk">
    ...
    <div class="transaction-details">
        ...
        <div class="products">
            ...
            <?php 
            $nama = $this->Kasir_Model->produkbyid($produk->ProdukID);
            ?>
