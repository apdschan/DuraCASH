        ...
        <div class="flex-container">
            ...
            <div class="card-container">
                <div class="card">
                    ...
                    <a href="<?php echo base_url("admin/produk/" . $data_admin->UserID)?>">Lihat Detail</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="<?php echo base_url("admin/customer/" . $data_admin->UserID)?>">Lihat Detail</a>
                </div>

                <div class="card">
                    <h2>Kasir</h2>
                    <h1><?php echo $total_kasir; ?></h1>
                    <a href="<?php echo base_url("admin/kasirpelanggan/" . $data_admin->UserID)?>">Lihat Detail</a>
                </div>
            </div>
